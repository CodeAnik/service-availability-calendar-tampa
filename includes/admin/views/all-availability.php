            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%;" class="shortcode-column"><?php esc_html_e( 'Shortcode', 'service-availability-calendar' ); ?></th>
                ...
                <tbody>
                    ...
                    foreach ( $availabilities as $availability ) :
                        ...
                        ?>
                        <tr>
                            <td data-label="<?php esc_attr_e( 'SL', 'service-availability-calendar' ); ?>"><?php echo esc_html( $sl_counter++ ); ?></td>  <td data-label="<?php esc_attr_e( 'Service Title', 'service-availability-calendar' ); ?>"><?php echo esc_html( $availability->post_title ); ?></td>
                            ...
                            <td data-label="<?php esc_attr_e( 'Shortcode', 'service-availability-calendar' ); ?>" class="shortcode-column"><code>[service_availability id="<?php echo esc_attr( $availability->ID ); ?>"]</code></td>
